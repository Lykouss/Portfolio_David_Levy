...
export const projectsData: Project[] = [
  {
    ...
    description: "Um jogo de RPG e magia. Um dos meus preferidos, onde pude aprimorar minhas habilidades trabalhando em equipe, com a Unity e integração com backend.",
